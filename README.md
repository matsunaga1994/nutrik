...
## 制作背景（意図）
- 料理のレパートリーを増やすこと、栄養バランスよく摂取できるようになることを目標にこのアプリを作成いたしました。
- その背景として、昨年度結婚いたしまして、嫁が手料理を作ってくれているのですが、「今日はなに作ろうかな」「野菜はしっかり取れているかな」とよく呟いていました。
- 料理投稿アプリは数多く存在し、栄養バランスも細かく表示されているものもありますが、機能が充実しているために少し使いづらい印象を受けました。
...
- 自分が投稿した料理、いいねした料理がいつもでも見返せるようにマイページを実装しました。【DEMO No.4参照】
...
# 今後実装したい機能
- いいね機能の非同期通信化
- 料理画像を複数枚投稿する際、画像の順番を入れ替えることができる機能
- 投稿した料理の編集機能
- ユーザーフォロー機能
- 材料名で検索ができる機能
